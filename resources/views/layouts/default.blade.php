...
<html lang="en">
    <head>
        ...
        <link href="{{asset("font-awesome/6.2.1/css/fontawesome.css")}}" rel="stylesheet"/>
        <script src="{{asset("font-awesome/6.2.1/js/all.js")}}" crossorigin="anonymous"></script>
        <link href="{{asset("css/styles_alt.css")}}" rel="stylesheet"/>
    </head>
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{("/")}}"><h3>Sisteminha </h3></a>
            <!-- Sidebar Toggle-->
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{route('logout')}}"  onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt fa-fw"></i>Logout</a></li>
                    </ul>
